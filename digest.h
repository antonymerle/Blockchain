...
int digest_merkle_root(uint8_t merkle_root[SHA256_DIGEST_LENGTH], size_t leaves_number, uint8_t leaves_bin[]);			// TODO : à la fin de l'implémentation, merkle_root doit être [SHA256_DIGEST_LENGTH]
